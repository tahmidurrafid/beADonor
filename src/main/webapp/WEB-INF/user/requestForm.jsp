    ...
    <div class = "topic-content">
        <div class = "items">
            <div class = "item dpView expanded">
                ...
                <div class = "details">
                    <form>
                        <input class = "input title" type = "text" placeholder="Your Title goes Here"/>
                        <div class = "bar">
                            <div class = "elem half">
                                <select>
                                    <option>Critical Medical Issue</option>
                                    <option>Other</option>
                                </select>                                
                            </div>
                        </div>
                        <div class = "elem">
                            <textarea placeholder="Please put your description here. Mention the issue in details."></textarea>
                        </div>
                        ...
                        <div class = "bar colap">
                            ...
                            <div class = "elem half">
                                ...
                                <div class = "elem">
                                    <input type = "text" placeholder="Name to contact"/>
                                </div>
                                <div class = "elem">
                                    <input type = "text" placeholder="Phone No"/>                                        
                                </div>
